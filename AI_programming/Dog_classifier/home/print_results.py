...
# PURPOSE:To Create a function print_results that prints the results statistics
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("Summary Statistics (Percentages) on {} Run ".format(model.upper()))
    ...
    if (print_incorrect_dogs and ( (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs']) != results_stats_dic['n_images'] )):
        ...
        for key, value in results_dic.items():
            if (sum(value[3:]) == 1):
                print("Pet Image Label: {:>20}       Classifier: {:>20}".format(value[0],value[1]))
